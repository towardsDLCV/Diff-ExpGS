...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.retinex_lr_init = 0.00016
        self.retinex_lr_final = 0.000016
        self.retinex_lr_delay_mult = 0.01
        ...
        self.depth_from = 0
        self.depth_end = 10_000
        self.depth_end_mult = 0.1
        self.lambda_depthanythingv2 = 1.0
